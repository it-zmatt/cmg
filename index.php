...
<body class="bg-[#F8F9FC]">
            ...
            <div class="flex items-center justify-between h-20">
                ...
                <div class="hidden lg:flex lg:items-center lg:gap-12">
                    ...
                    $navItems = [
                        ...
                        ['href' => '#direction', 'text' => 'Contact Us']
                    ];
    ...
    <section id="direction" class="relative bg-cover bg-center bg-no-repeat py-10" style="background-image: url('./assets/image/location.png');">
        <!-- Overlay -->
                    ...
                    <div class="bg-[#704B7D]/80 backdrop-blur-md  rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-all duration-300">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <div class="text-[#F8F9FC]/80 mt-2 space-y-1">
